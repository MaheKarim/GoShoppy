        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <form action="{{ route('app.status.update', $statuses->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="status" type="text" class="form-control @error('status') is-invalid @enderror"
                                       name="status" value="{{ $statuses->status ??  old('status') }}" required autofocus>
                                <input type="hidden" name="status_id"  value="{{ $statuses->id }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="status_description" type="text" class="form-control @error('status_description') is-invalid @enderror"
                                       name="status_description" value="{{ $statuses->status_description ??  old('status_description') }}">
