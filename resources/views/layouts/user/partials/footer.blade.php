                    ...
                    <div class="dropdown">
                        <a aria-haspopup="true" aria-expanded="false" data-toggle="dropdown"
                           class="dot-btn-wrapper">
                            ...
                            <div class="badge badge-dot badge-abs badge-dot-sm badge-danger">Notifications
                            </div>
                        </a>
                                        ...
                                        <div class="no-gutters row">
                                            ...
                                            <div class="col-sm-6 col-xl-6">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item"><a class="nav-link">Campaigns</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item-btn clearfix nav-item">
                                        ...
                                        <div class="float-right">
                                            <button class="btn-shadow btn btn-info btn-sm">Info Button
                                            </button>
                                        </div>
                                    </li>
                                </ul>
